...
for year_idx in range(2004,2014):
    ...
    path= '/home/nochi/PCA/python/dataset_scattered/'
    path += year_idx
    ...
    print('In total ' + str(error_count) + ' errors')
    ...
    save_name = '../../dataset_merged/raw_workbook_' + year_idx + '.xlsx' 
    wb.save(save_name)

print('=======================\n Total errors: ' + str(total_exception_count))
